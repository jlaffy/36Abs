immh103MV2small <- read.csv("/Users/julielaffy/OneDrive/36Abs/results/kappa_pairs/proABC/imml103/immh103MV2small/Prob_heavy.csv")
immh103MV2big <- read.csv("/Users/julielaffy/OneDrive/36Abs/results/kappa_pairs/proABC/imml103/immh103MV2big/Prob_heavy.csv")
...
legend('topright', c("small antigen vol","large antigen vol"), fill=c("purple","orange"), bty="n", cex = 0.85, title = "immh103MV2-imml103")

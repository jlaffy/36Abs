#!/usr/bin/Rscript
preh149MU5lam <- read.csv("/Users/julielaffy/36Abs/results/lambda_pair/proABC/preh149MU5/preh149MU5big/Prob_Heavy.csv")
...
write.csv(df, file = "~/36Abs/results/nail120-imml103/preh149MU5_120103.csv")

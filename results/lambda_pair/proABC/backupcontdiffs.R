#!/usr/bin/Rscript
preh149MU5small <- read.csv("/Users/julielaffy/36Abs/results/lambda_pair/proABC/preh149MU5/preh149MU5small/Prob_Heavy.csv")
preh149MU5big <- read.csv("/Users/julielaffy/36Abs/results/lambda_pair/proABC/preh149MU5/preh149MU5big/Prob_Heavy.csv")

#select rows from data.frame
cont_all <- preh149MU5small[2,]
cont_all_big <- preh149MU5big[2,]
...
write.csv(df, file = "~/36Abs/results/lambda_pair/proABC/preh149MU5/preh149MU5cont_diff.csv")

#!/usr/bin/Rscript
preh149MU5kap2 <- read.csv("/Users/julielaffy/36Abs/results/kappa_pairs/proABC/NAIL107/preh149MU5/preh149MU5big/Prob_Heavy.csv")
preh149MU5kap <- read.csv("/Users/julielaffy/36Abs/results/kappa_pairs/proABC/IMML103/preh149MU5/preh149MU5big/Prob_Heavy.csv")

#select rows from data.frame
cont_all_kap2 <- preh149MU5kap2[2,]
...
write.csv(df, file = "~/36Abs/results/imml103-nail107/preh149MU5_120103.csv")
